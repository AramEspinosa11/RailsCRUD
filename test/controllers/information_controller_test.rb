...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference("Information.count") do
      post information_index_url, params: { information: { age: @information.age, email: @information.email, first_name: @information.first_name, last_name: @information.last_name, phone: @information.phone, string: @information.string } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { age: @information.age, email: @information.email, first_name: @information.first_name, last_name: @information.last_name, phone: @information.phone, string: @information.string } }
