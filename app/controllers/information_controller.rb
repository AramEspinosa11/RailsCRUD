class InformationController < ApplicationController
  ...
  def new
    ...
    @information =  current_user.information.build
  end
  ...
  def correct_user
    @information = current_user.information.find_by(id: params[:id])
    redirect_to information_index_path, notice: "Not Authorized To Edit this Friend - Sucker!" if @information.nil?
  end
  ...
  private
    ...
    def information_params
      params.require(:information).permit(:first_name, :last_name, :email, :phone, :age, :user_id)
    end
end
